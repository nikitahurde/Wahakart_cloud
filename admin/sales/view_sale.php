            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="client" class="control-label text-info">Product Name</label>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        ...
                        <th class="text-center py-1 px-2">Used Qty</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="py-1 px-2 text-right">
                                ...
                                $formattedAvailable = number_format($available, 2, '.', ',');

                                echo $formattedAvailable;
                                ?>
                            </td>
                            ...
                            <td class="py-1 px-2 text-right">
                                ...
                                // Use number_format with explicit locale (e.g., English - United States)
                                $formattedRem = number_format($rem, 2, '.', ',');
                            ...
                            <td class="py-1 px-2 text-right">
                                ...
                                // Use number_format with explicit locale (e.g., English - United States)
                                $formattedRem = number_format($price, 2, '.', ',');
                            ...
                            <td class="py-1 px-2 text-right">
                                ...
                                // Use number_format with explicit locale (e.g., English - United States)
                                $formattedRem = number_format($total, 3, '.', ',');
