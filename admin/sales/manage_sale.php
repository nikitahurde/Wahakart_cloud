                        ...
                        <div class="row justify-content-center align-items-end">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" class="form-control rounded-0" id="qty" onchange="cal_remaining_qty()">
                                </div>
                            </div>
                            ...
                            <div>
                                <p>Converted Price: <span id="convertedPrice"></span></p>
                            </div>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th class="text-right py-1 px-2" colspan="5">Total
                                    <input type="hidden" name="amount" value="<?php echo isset($amount) ? number_format($amount, 3) : 0 ?>">
                                </th>
                                <th class="text-right py-1 px-2 grand-total"><?php echo isset($amount) ? number_format($amount, 3) : 0 ?></th>
                            </tr>
                        </tfoot>
                    </table>
                    <div class="row">
...
<script>
    ...
    var convertedPriceSpan = document.getElementById("convertedPrice");
    ...
    unitSelect.addEventListener("change", function() {
        ...
        if (selectedUnit === "gm") {
            ...
            convertedPriceSpan.textContent = convertedPrice.toFixed(2);
        } else if (selectedUnit === "ml") {
            var convertedPrice = price / 1000;
            convertedPriceSpan.textContent = convertedPrice.toFixed(2);
        } else {
            convertedPriceSpan.textContent = "";
        }
    });
