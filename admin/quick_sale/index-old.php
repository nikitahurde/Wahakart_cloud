            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="hidden" class="form-control form-control-sm rounded-0" value="<?php echo isset($sales_code) ? $sales_code : '' ?>" readonly>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <!-- <label for="client" class="control-label text-info">Client Name</label> -->
                            <input type="hidden" name="client" class="form-control form-control-sm rounded-0" value="<?php echo isset($client) ? $client : 'Guest' ?>" >
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <fieldset>
                    <legend class="text-info">Quick Sale</legend>
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select  id="item_id" name="item_id"class="select2 select2-dropdown" autofocus  
                                 onchange="changeLanguage(this.value)">
                                    <option disabled selected autofocus></option>
                                    <?php foreach($item_arr as $k =>$v): ?>
                                        <option autofocus value="<?php echo $k ?>"> <?php echo $v['barcode_no'] ?></option>
                                    <?php endforeach; ?>
                                    
                                    
                             
                                <!-- <span class="select2 select2-container select2-container--default select2-container--below select2-container--open" dir="ltr" data-select2-id="112" style="width: 355.75px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="true" tabindex="0" aria-disabled="false" aria-labelledby="select2-item_id-container" aria-owns="select2-item_id-results" aria-activedescendant="select2-item_id-result-3b4x-28"><span class="select2-selection__rendered" id="select2-item_id-container" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">Please select here</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="false"></span></span> -->
                        ...
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="kk" 
                                onclick="myFunction()">Add to List</button>
                            </div>
                        </div> 
                </fieldset>
                <hr>
...
window.onload = function() {
        ...
        var selectField = document.getElementById('item_id');
        // Select the field
...
$('item_id').on('shown.bs.dropdown', function () {
