			...
			<div class="container-fluid">
				<table class="table table-hovered table-striped">
					...
					<tbody>
						...
						$i = 1;
						$qry = $conn->query("SELECT i.*,s.categories_name as categories from `item_list` i inner join categories s on i.categories_id = s.id order by i.name asc,s.categories_name asc");
						...
						?>
							<tr>
								...
								<td hidden><?php echo $row['categories'] ?></td>
								<?php
			...
			<div class="modal-body">
				...
				<div class="myform">
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<?php
						// Assuming you have the selected category ID and its corresponding brand ID before rendering the dropdown
						$selectedCategoryId = 1; // Replace this with the actual selected category ID from the database
						$selectedBrandId = 1;    // Replace this with the corresponding brand ID for the selected category from the database
...
if (isset($_POST['upload'])) {
	...
	$query = "INSERT INTO `item_list`(`name`,`description`,`profile`,`cost`,`categories_id`,`brands_id`) VALUES ('$name','$description','$img_path','$cost','$categories_id','$brands_id')";
