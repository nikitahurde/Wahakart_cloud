        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT p.*, s.categories_name as categories FROM `purchase_order_list` p inner join categories s on p.categories_id = s.id order by p.`date_created` desc");
