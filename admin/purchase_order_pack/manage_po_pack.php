<?php
if (isset($_GET['id'])) {
    $qry = $conn->query("SELECT p.*,s.categories_name as categories FROM purchase_order_list p inner join categories s on p.categories_id = s.id  where p.id = '{$_GET['id']}'");
    if ($qry->num_rows > 0) {
...
<div class="card card-outline card-primary">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="supplier" class="control-label">Select Product</label>
                ...
                <fieldset>
                    ...
                    <div class="row " style="align-items:left;">
                        ...
                        $item_arr = array();
                        $cost_arr = array();
                        $item = $conn->query("SELECT * FROM `item_list_p` where status = 1 order by `name` asc");
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=purchase_order_pack' ?>">Cancel</a>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        $('#add_to_list').click(function() {
            ...
            var item_description = items[categories][item].description;
        ...
        $('#po-form').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_po_pack",
                ...
                success: function(resp) {
                    if (resp.status == 'success') {
                        location.replace(_base_url_ + "admin/?page=purchase_order_pack/view_po_pack&id=" + resp.id);
