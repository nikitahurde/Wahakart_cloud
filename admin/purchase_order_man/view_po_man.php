...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Manpower managment Details - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="categories_id" class="control-label text-info">Products List</label>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="py-1 px-2 text-center"><?php echo ($row['time']) ?></td>
                            <td class="py-1 px-2 text-center"><?php echo date('d-m-Y', strtotime($row['aaaa'])); ?></td>

                            <td hidden class="py-1 px-2 text-center"><?php echo number_format($row['quantity'], 2) ?></td>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url . '/admin?page=purchase_order_man/manage_po_man&id=' . (isset($id) ? $id : '') ?>">Edit</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=purchase_order_man' ?>">Back To List</a>
    </div>
</div>
