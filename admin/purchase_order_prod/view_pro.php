...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Product Order Details - <?php echo $po_code ?></h4>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url . '/admin?page=purchase_order_prod/manage_pro&id=' . (isset($id) ? $id : '') ?>">Edit</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=purchase_order_prod' ?>">Back To List</a>
    </div>
</div>
