        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT r.*, s.categories_name as categories FROM `return_list` r inner join categories s on r.categories_id = s.id order by r.`date_created` desc");
