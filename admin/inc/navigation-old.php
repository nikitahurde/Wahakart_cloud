              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=purchase_order/po_expiry" class="nav-link nav-stock_expiry">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Stock Expiry
                        </p>
                    ...
                    <li class="nav-item">
                      ...
                      <a href="<?php echo base_url ?>admin/?page=quick_sale" class="nav-link nav-quick_sale">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/purchase" class="nav-link nav-purchase-reports">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/sale" class="nav-link nav-sales-reports">
                        <i class="nav-icon  fas fa-file"></i>
                        <p>
                        Sales Reports
                        </p>
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/expense" class="nav-link nav-expense-reports">
                        <i class="nav-icon  fas fa-file"></i>
                        <p>
                          Expense Reports
                        </p>
