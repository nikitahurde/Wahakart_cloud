				...
				<colgroup>
					...
					<col width="15%">
                      ...
                      <?php
                            ...
                            $query = "SELECT * FROM sales_list WHERE date_updated BETWEEN '$start_date' AND '$end_date'";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    ?>
                                      <tr>
                                          <td class="text-center"><?= $row['sales_code']; ?></td>
                           ...
                           <tr>
                             ...
                             <th class="text-center"><spam style="font-weight:500;color:grey;">Total Sales </spam><br><?php echo $final_price?></th>
...
$(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Sales Report - Print View")
