<?php
if (isset($_GET['id'])) {
    $qry = $conn->query("SELECT * FROM sales_list_prod where id = '{$_GET['id']}'");
    if ($qry->num_rows > 0) {
            ...
            <div class="container-fluid">
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        $item_arr = array();
                        $cost_arr = array();
                        $item = $conn->query("SELECT s.*,i.name,i.description,i.id FROM `stock_list_prod` s inner join products_list i on s.item_id = i.id  order by `name` asc");
...
<script>
    ...
    $(function() {
        ...
        $('#sale-form').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_sale_prod",
                ...
                success: function(resp) {
                    if (resp.status == 'success') {
                        location.replace(_base_url_ + "admin/?page=sales_prod/view_sale_prod&id=" + resp.id);
