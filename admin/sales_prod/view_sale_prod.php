<?php
$qry = $conn->query("SELECT * FROM sales_list_prod r  where id = '{$_GET['id']}'");
if ($qry->num_rows > 0) {
...
<div class="card card-outline card-primary">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        ...
                        <th hidden class="text-center py-1 px-2">Available</th>
                        <th class="text-center py-1 px-2">Qty</th>
                        <th class="text-center py-1 px-2">Unit</th>
                        <th hidden class="text-center py-1 px-2">Remaining</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td hidden class="py-1 px-2 text-right"><?php echo number_format($row['available']) ?></td>
                            <td class="py-1 px-2 text-center"><?php echo number_format($row['quantity']) ?></td>
                            <td class="py-1 px-2 text-center"><?php echo ($row['unit']) ?></td>
                            <td hidden class="py-1 px-2 text-right"><?php echo number_format($row['rem']) ?></td>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url . '/admin?page=sales_prod/manage_sale_prod&id=' . (isset($id) ? $id : '') ?>">Edit</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=sales_prod' ?>">Back To List</a>
    </div>
</div>
